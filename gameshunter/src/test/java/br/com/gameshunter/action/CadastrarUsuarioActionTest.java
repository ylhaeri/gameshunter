...
public class CadastrarUsuarioActionTest {
	...
	public void main() {
		...
		Select dpPais = new Select(driver.findElement(By.name("endereco.pais")));
		Select dpEstado = new Select(driver.findElement(By
		...
		new WebDriverWait(driver, 10).until(ExpectedConditions
				.textToBePresentInElementLocated(By.name("endereco.estado"),
						"São Paulo"));
