...
<html>
<s:textfield label="CEP" labelposition="top" labelSeparator="" id="cept"
	name="endereco.cep" value="%{endereco.cep}" errorPosition="bottom"></s:textfield>
...
<s:textfield label="N.º" labelposition="top" labelSeparator="" id="numt"
