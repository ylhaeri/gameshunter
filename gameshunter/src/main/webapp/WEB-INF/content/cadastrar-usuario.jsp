...
<body class="container">
	...
	<form method="post" class="cadastro" action="novoUsuario">
		<label for="nome">Nome</label><input type="text" id="nome"
			name="usuario.nome"> <br /> <label for="ape">Apelido</label><input
			type="text" name="usuario.apelido" id="ape"> <br /> <label
			for="mail">E-mail</label><input type="text" name="usuario.email"
			id="mail"> <br /> <label for="senha">Senha</label><input
			type="password" id="senha"> <br /> <label
			for="confirmasenha">Confirme sua senha</label><input type="password"
			id="confirmasenha" name="usuario.senha"> <br /> <label
			for="cpf">CPF</label><input type="text" id="cpf" name="usuario.cpf">
		<br /> <label for="tel">Telefone</label><input type="text" id="tel"
			name="usuario.telefone"> <br /> <label for="rg">RG</label><input
			type="text" id="rg" name="usuario.rg"> <br /> <label
			id="sexo" for="gndbx">Sexo</label><select name="usuario.sexo">
			<option selected="selected">---Selecione---</option>
			<c:forEach var="sexo" items="${sexo}">
				<option>${sexo}</option>
			</c:forEach>
		</select> <br /> <label id="dtnasc" for="diabox">Data de Nascimento</label> <br />
