...
<form action="#" method="post">
	<fieldset class="info-user">
		...
		<div>
			<label>Sexo</label> Masculino<input type="radio" value="Masculino">
			Feminino<input type="radio" value="Feminino">
		</div>
		...
		<div>
			<label>Confirme sua senha</label><input type="text">
		</div>

		<div>
			<label>Receber novaidades por e-mail</label> Sim <input type="radio"
				value="Sim"> Não <input type="radio" value="Não">
		</div>
		<div>
			<label>Termos de uso</label> <input type="checkbox"
				value="Eu li tudo hu3">
		</div>
	...
	<tr>
		...
		<td class="td-input" id="td-cpf-input"><form:input id="cpf-input"
				class="form-control" path="user.cpf" /> <form:errors
				path="user.cpf" cssClass="text-danger" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td-input" id="td-dia-nascimento-input"><form:input
				id="nascimento-input" class="form-control" path="user.birthDay" />
			<form:errors path="user.birthDay" cssClass="text-danger" /></td>
	</tr>
