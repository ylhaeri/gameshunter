...
<tr>
	...
	<td class="td-input" id="td-apelido-input"><input
		...
		name="apelido" value="${usuario.apelido}"> <br /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="td-input" id="td-confirma-senha-input"><input
		...
		name="senha"><span id="confirma-senha-feed"></span><br />
...
<tr class="data-nascimento-tr">
	...
	<td class="td-input" id="td-dia-nascimento-input"><select><c:forEach
				var="dia" begin="1" end="31">
				<option>${dia}</option>
			</c:forEach></select></td>
	<td class="td-input" id="td-mes-nascimento-input"><select><c:forEach
				var="mes" items="${mesList}">
				<option>${mes}</option>
			</c:forEach></select></td>
